...
enum TokenType {
	...
	// Other Operators:
	INSERTION_TOKEN, ASSIGNMENT_TOKEN, PLUSEQUAL_TOKEN, MINUSEQUAL_TOKEN, PLUS_TOKEN, MINUS_TOKEN,
...
const std::string gTokenTypeNames[] = {
	...
	"INSERTION","ASSIGNMENT","PLUSEQUAL", "MINUSEQUAL","PLUS","MINUS","TIMES","DIVIDE",
	"AND", "OR",
